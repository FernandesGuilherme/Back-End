...
abstract class Pessoa implements Cliente, Fornecedor, Usuario {
    ...
    protected Collection <Acesso> acesso;
    protected Collection <Endereco> endereco;
    ...
    public Pessoa (String nome,String telefoneFixo, double rendaBruta, String login,  String senha) {
        ...
        this.acesso = new ArrayList<Acesso>();
    ...
    public Collection <Endereco> getEnderecoo (){
