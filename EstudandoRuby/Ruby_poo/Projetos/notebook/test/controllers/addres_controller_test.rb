...
class AddresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create addre" do
    assert_difference('Addre.count') do
      post addres_url, params: { addre: { Contact_id: @addre.Contact_id, city: @addre.city, state: @addre.state, street: @addre.street } }
    end
  ...
  test "should update addre" do
    patch addre_url(@addre), params: { addre: { Contact_id: @addre.Contact_id, city: @addre.city, state: @addre.state, street: @addre.street } }
